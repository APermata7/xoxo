...
public class BioskopActivity extends AppCompatActivity implements BioskopAdapter.BioskopFavoriteListener {
    ...
    // Use static map to persist data across activities
...
//        });
    ...
    protected void onResume() {
        super.onResume();
        // Refresh the adapter when returning to this activity
        if (currentCity != null) {
            List<Bioskop> bioskops = bioskopPerKota.get(currentCity);
    ...
    private void initializeData() {
        // Malang cinema data with detailed info
        List<Bioskop> malangCinemas = new ArrayList<>();
        malangCinemas.add(new Bioskop("Araya XXI", false,
                "Jalan Blimbing Indah Megah no. 2, Araya Mall, Lantai 3",
                "0812-3456-7890"));
        malangCinemas.add(new Bioskop("Dieng", false,
                "Jalan Dieng no. 15, Dieng Plaza, Lantai 1",
                "0811-2345-6789"));
        malangCinemas.add(new Bioskop("Lippo Plaza Batu Cinepolis", false,
                "Jalan Diponegoro no. 78, Lippo Plaza Batu, Lantai 2",
                "0813-4567-8901"));
        malangCinemas.add(new Bioskop("Malang City Point CGV", false,
                "Jalan Tenes no. 12, Malang City Point, Lantai 4",
                "0814-5678-9012"));
        malangCinemas.add(new Bioskop("Malang Town Square Cinepolis", false,
                "Jalan Veteran no. 8, Malang Town Square, Lantai Upper Ground, Unit UG-03",
                "0815-6789-0123"));
        malangCinemas.add(new Bioskop("Transmart Mx Mall XXI", false,
                "Jalan Veteran no. 15, Transmart Mx Mall, Lantai 3",
                "0817-8901-2345"));
        malangCinemas.add(new Bioskop("Mandala", false,
                "Jalan Mandala no. 9, Daerah Mandala, Lantai 2",
                "0817-8901-2222"));
        bioskopPerKota.put("Malang", malangCinemas);

        // Surabaya cinema data
        List<Bioskop> surabayaCinemas = new ArrayList<>();
        surabayaCinemas.add(new Bioskop("Tunjungan Plaza XXI", false,
                "Jalan Basuki Rahmat no. 8-12, Tunjungan Plaza, Lantai 4",
                "0818-9012-3456"));
        surabayaCinemas.add(new Bioskop("Pakuwon Mall CGV", false,
                "Jalan Puncak Indah Lontar no. 2, Pakuwon Mall, Lantai 3",
                "0819-0123-4567"));
        surabayaCinemas.add(new Bioskop("Galaxy Mall Cinepolis", false,
                "Jalan Dharmahusada Indah Timur no. 35-37, Galaxy Mall, Lantai 2",
                "0820-1234-5678"));
        bioskopPerKota.put("Surabaya", surabayaCinemas);

        // Blitar cinema data
        List<Bioskop> blitarCinemas = new ArrayList<>();
        blitarCinemas.add(new Bioskop("Blitar Square XXI", false,
                "Jalan Merdeka no. 39, Blitar Square, Lantai 2",
                "R0821-2345-6789"));
    ...
    // Static method to access bioskop data from other activities
...
//        } else if (id == R.id.bioskop_profile || id == R.id.profile) {
//            // Klik pada ikon profil di header atau navbar
//            Intent intent = new Intent(BioskopActivity.this, ProfileActivity.class);
//            startActivity(intent);
//            overridePendingTransition(0, 0);
//            finish(); // Jika ingin langsung keluar dari halaman ini
//        }
    }
